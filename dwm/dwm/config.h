...
static const char *upvol[] = {"/home/norm/.local/bin/volup", NULL};

static const char *downvol[] = {"/home/norm/.local/bin/voldown", NULL};

static const char *mutevol[] = {"/home/norm/.local/bin/volmute", NULL};

static const char *light_up[] = {"/home/norm/.local/bin/brightup", NULL};

static const char *light_down[] = {"/home/norm/.local/bin/brightdown", NULL};
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_s, spawn,
     SHCMD("mkdir -p ~/Pictures/Screenshots && maim --select "
           "/home/norm/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png")},
    {MODKEY, XK_space, spawn,
     SHCMD("env "
           "XDG_DATA_DIRS=/var/lib/flatpak/exports/share:/usr/local/share:/usr/"
           "share rofi -show drun")},
    {MODKEY, XK_Return, spawn, SHCMD("st")},
    {MODKEY, XK_c, spawn, SHCMD("st -e nvim")},
    ...
    {MODKEY, XK_d, spawn,
     SHCMD("flatpak run com.discordapp.Discord")}, // shift view
